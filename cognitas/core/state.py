...
class GameState:
    ...
    def is_day_active(self) -> bool:
        import time
        return bool(self.day_channel_id and self.day_deadline_epoch and self.day_deadline_epoch > int(time.time()))

    def is_night_active(self) -> bool:
        import time
        return bool(self.night_deadline_epoch and self.night_deadline_epoch > int(time.time()))
