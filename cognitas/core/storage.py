...
def load_state(path: str):
    ...
    game.night_channel_id = data.get("night_channel_id", None)
    game.night_deadline_epoch = data.get("night_deadline_epoch", None)
    game.next_day_channel_id = data.get("next_day_channel_id", None)
